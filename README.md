...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/nvidia-gds-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/nvidia-gds-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install nvidia-gds
```
...
It is possible to list all of the versions of `nvidia-gds` available on your platform:
...
```
pixi search nvidia-gds --channel conda-forge
```
